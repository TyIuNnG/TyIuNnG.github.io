...
// loop
// The feedback for loop button is that when it's toggled, the background will be darker, indicating that the function has been toggled
// If a button is different than the background color, that usually means the button has been activated or hover on
function loopToggle(){
  ...
  if (videoElement.loop){
    ...
    loopButton.style.backgroundColor = "#bcbdbc";
  }
}
